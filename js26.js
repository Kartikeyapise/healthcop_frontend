(function(global) {
    global.$_Tawk_AccountKey = '5fcb68db920fc91564cdbbc4';
    global.$_Tawk_WidgetId = 'default';
    global.$_Tawk_Unstable = false;
    global.$_Tawk = global.$_Tawk || {};
    (function(b) {
        var a = { pluralFormFunction: function(a) { return 1 === a ? "one" : "other" }, form: {} };
        ...
        a.transcript = {};
        a.transcript.transcriptSubject = { message: "Chat email transcript on #host started on #startedOn", vars: ["host", "startedOn"] };
        ...
        a.chat.departmentIsOffline = { message: "Department #strongStart #departmentName #strongEnd is currently offline. You might be served by another department.", vars: ["departmentName", "strongStart", "strongEnd"] };
        ...
        a.chat.new_conversation = { message: "New Conversation" };
        a.status = {};
        ...
        a.notifications = {};
        a.notifications.maximum_file_upload_warning = { message: "Sorry, file transfer is limited to #limitFileNumber files at a time. Please try the following file(s) again :", vars: ["limitFileNumber"] };
        ...
        a.chat = a.chat || {};
        a.chat.messageQueuedText = { vars: ["strongStart", "strongEnd"], pluralVars: ["t"], message: { one: "Estimated wait time is #strongStart #t minute #strongEnd", other: "Estimated wait time is #strongStart #t minutes #strongEnd" } };
    ...
    (function(a) {
        function c() { var a = document.getElementsByTagName("script")[0],
                b = document.createElement("script");
            b.async = !0;
            b.src = "https://static-v.tawk.to/698/app.js";
            b.charset = "UTF-8";
            b.setAttribute("crossorigin", "*");
            a.parentNode.insertBefore(b, a) } "complete" === document.readyState ? c() : a.attachEvent ? a.attachEvent("onload", c) : a.addEventListener("load", c, !1) })(window);
